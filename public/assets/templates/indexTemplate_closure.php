<?php
	//ob_start();
	include_once ( 'fiptext.php' );
	$page_title = "FIP, Federation of Indian Photography";
...
<h2 class="maintxt"><?php echo $word; ?> FIP Grand International Circuit <?php echo Date('Y'); ?></h2>
</div>
...
<table width=70% align=right>
	<tr valign=baseline align=center>
		...
		<td style="padding:0 0%;"><img src="assets/img/img0009.png" width="69" />
		<br />
		<p><small><?php echo $fiap; ?></small></p>
		</td>
	</tr>
</table>
...
<div align="center" class="" style="margin:0;" >
	...
	<div class="pure-g setpos">		
		...
		<a id="ad" class="btn btn-primary mypure" role="button" href="login.php">Login</a>
		<!--<a id="ad" class="btn btn-primary mypure" role="button" href="assets/results/index.htm" style="color:yellow;font-weight:bold;">View Results</a>-->
		<a id="ad" class="btn btn-primary mypure" role="button" target="_blank" href="assets/results/result_index.htm" style="color:yellow;font-weight:bold;">View Results</a>
		<a id="ad" class="btn btn-primary mypure" role="button" href="#">Rules</a>		
