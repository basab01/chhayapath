<?php
	//ob_start();
	$page_title = "Admin update :: Payment Status :: $title";
...
<div class="center" style="padding:0 5% 0 5%;">
    ...
    <h2 style="padding:0 0 20px 0; font-weight:normal; color: #408080; text-align:right;">Payment Status Update</h2>
...
<div class="center" style="text-align : right;">
		...
		<a href="statusdisplayadmin.php?type=<?php echo $type; ?>&token=<?php echo $ttok; ?>" class="btn btn-primary">User Status</a>
...
<center>
				<div id="total">
					...
					<div class=cont>
						<h1>Select Payment Status of User</h1>
						
						
						<div class="form-group grp">
							<div class="control-label lefty">Payment Received *</div>
